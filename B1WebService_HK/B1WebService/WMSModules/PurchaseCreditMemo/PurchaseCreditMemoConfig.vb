Public Class PurchaseCreditMemoConfig : Inherits SAPConfig
...
#End Region
    ...
    Public Sub New(ByVal _Setting As Settings)
        MyBase.New(_Setting, Settings.WMSModule.APCREDITMEMO)
    ...
    Private Sub setConfig()
        ...
        Try
            _KeyField = _Setting.getValue(Settings.WMSModule.APCREDITMEMO.ToString & FUNC_KEYCOLUMN)
            _KeyLineField = _Setting.getValue(Settings.WMSModule.APCREDITMEMO.ToString & FUNC_KEYLINECOLUMN)
