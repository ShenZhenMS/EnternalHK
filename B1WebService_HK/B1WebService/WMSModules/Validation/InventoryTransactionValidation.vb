Public Class InventoryTransactionValidation : Inherits Validation
    ...
    Public Sub New(ByVal _Setting As Settings, ByVal _dt As DataTable)
        MyBase.New(_Setting, Settings.WMSModule.STOCKTRN)
        ...
        _Debug.WriteTable(_dt, "Inventory transfer Table")
    End Sub
