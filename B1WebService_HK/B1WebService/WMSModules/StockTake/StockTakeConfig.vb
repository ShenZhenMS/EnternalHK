Public Class StockTakeConfig : Inherits SAPSQLConnections
...
#End Region
    ...
    Private Sub setConfig()
        _dtConfig = MyBase.WMSConfig(Settings.WMSModule.STOCKTAKE.ToString)
        _dtModule = MyBase.WMSModule(Settings.WMSModule.STOCKTAKE.ToString)
        _isError = False
        _Message = ""
