Public Class SalesCreditMemoForSAP : Inherits SAPSQLConnections
    ...
    Public Shared VALUE_DocType As String = "SR"
    ...
    Public Function OpenList(ByVal _DocNum As String, ByVal _CardCode As String, ByVal _DateFrom As String, ByVal _DateTo As String) As DataTable
        Dim _dt As DataTable
        Dim _sql = _sqlOpenList & String.Format(" AND {0} = '{1}' AND 1 = 1 ", EXP_FLD_DOCTYPE, VALUE_DocType)
    ...
    Public Function DocumentStatus(ByVal _ReceiveEntry As String) As DataTable
        ...
        Try
            _dt = MyBase.ExecuteDatatable(String.Format(_sqlDocStatus, _ReceiveEntry, DIServer_ARCreditMemo.ObjType))
