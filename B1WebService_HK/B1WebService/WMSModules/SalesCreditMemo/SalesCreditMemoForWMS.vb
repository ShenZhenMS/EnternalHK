Public Class SalesCreditMemoForWMS : Inherits SalesCreditMemo
        ...
        Try
            _sql = String.Format(_sqlCreateHist,
                     ...
                     Settings.DBNull(_dr(Fld_ItemCode)), _
                                 ...
                                 Settings.DBNull(_dr(Fld_ReasonCode)), Settings.DBNull(_dr(Fld_isProblem), "N"), Settings.DBNull(_dr(Fld_isDamage), "N"), Settings.DBNull(_dr(Fld_BaseEntry), "-1"), Settings.DBNull(_dr(Fld_BaseLine), "-1"))
