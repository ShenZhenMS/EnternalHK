Public Class SalesCreditMemoConfig : Inherits SAPConfig
...
#Region "ModuleFunction"
    ...
    Public Shared FUNC_PROBLEMWHSE As String = "PROBLEMWHSE"
    Public Shared FUNC_DAMAGEWHSE As String = "DAMAGEWHSE"
...
#End Region
    ...
    Private Sub setConfig()
        ...
        Try
            _KeyField = _Setting.getValue(Settings.WMSModule.ARCREDITMEMO.ToString & FUNC_KEYCOLUMN)
            _KeyLineField = _Setting.getValue(Settings.WMSModule.ARCREDITMEMO.ToString & FUNC_KEYLINECOLUMN)
